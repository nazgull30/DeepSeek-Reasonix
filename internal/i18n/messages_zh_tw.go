...
var ChineseTraditional = Messages{
	...
	SlashHelp:          "命令：/compact · /new（/clear）· /resume · /session-delete · /rewind · /tree · /branch · /switch · /todo · /verbose · /model（切換模型）· /effort · /theme · /language · /mcp · /skills · /hooks · /paste-image · /memory · /migrate · /remember · /quit · /help · 以及 skills（/init、/explore …）",
...
`,
	...
	NoSessionToDelete:          "沒有可刪除的已儲存會話",
	SessionDeletePickTitle:     "刪除一個已儲存會話",
	SessionDeletePickHint:      "↑/↓ 選擇 · Enter 確認 · Esc 取消",
	SessionDeletePromptFmt:     "刪除會話 %s？此操作無法復原。",
	SessionDeletePromptMeta:    "將刪除對話記錄、分支歷史、檢查點以及子代理會話。",
	SessionDeleteDone:          "會話已刪除",
	SessionDeleteFailed:        "刪除會話失敗",
	SessionDeleteActive:        "無法刪除目前活動會話——請使用 /clear 捨棄它",
	StatusSessionDeletePicker:  "刪除會話",
	CmdClear:                   "丟棄當前上下文",
	CmdRename:                  "重新命名會話",
	CmdGoal:                    "設定或清除當前目標",
