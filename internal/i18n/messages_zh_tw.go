...
var ChineseTraditional = Messages{
	...
	InputCopied:                  "已複製輸入內容到剪貼簿",
	InputCopyEmpty:               "輸入為空，沒有可複製的內容",
	...
	CmdExportSessions:          "匯出所有會話狀態用於快取分析",
	...
	SlashExportSessionsDoneFmt: "會話快照已匯出到 %s",
	SlashExportSessionsEmpty:   "沒有可匯出的會話",
