...
type Messages struct {
	...
	InputCopied        string // Ctrl+X copied the composer draft to the clipboard
	InputCopyEmpty     string // Ctrl+X with nothing in the composer
	...
	CmdExportSessions          string // /export_sessions
	...
	SlashExportSessionsDoneFmt string // "/export_sessions" succeeded, %s = dir path
	SlashExportSessionsEmpty   string // no sessions to export
