...
var Chinese = Messages{
	...
	InputCopied:                  "已复制输入内容到剪贴板",
	InputCopyEmpty:               "输入为空，没有可复制的内容",
	...
	CmdExportSessions:          "导出全部会话状态用于缓存分析",
	...
	SlashExportSessionsDoneFmt: "会话快照已导出到 %s",
	SlashExportSessionsEmpty:   "没有可导出的会话",
	...
	FlowStatusLabel:     "流程",
	FlowTagSubagent:     "子代理",
	FlowTagOrchestrator: "编排代理",
	FlowTotalAll:        "总计（所有代理）",
