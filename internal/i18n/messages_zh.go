...
var Chinese = Messages{
	...
	NoSessionToDelete:         "没有可删除的已保存会话",
	SessionDeletePickTitle:    "删除一个已保存会话",
	SessionDeletePickHint:     "↑/↓ 选择 · Enter 确认 · Esc 取消",
	SessionDeletePromptFmt:    "删除会话 %s？此操作无法撤销。",
	SessionDeletePromptMeta:   "将删除对话记录、分支历史、检查点以及子代理会话。",
	SessionDeleteDone:         "会话已删除",
	SessionDeleteFailed:       "删除会话失败",
	SessionDeleteActive:       "不能删除当前活动会话——请使用 /clear 丢弃它",
	StatusSessionDeletePicker: "删除会话",
	SlashUnavailable:          "当前构建不支持该命令",
	SlashUnknown:              "未知命令",
	SlashTodoCleared:          "已清除任务清单",
	SlashHelp:                 "命令：/compact · /new · /clear · /resume · /session-delete · /rewind · /tree · /branch · /switch · /todo · /verbose · /model（切换模型）· /effort · /theme · /language · /mcp · /skills · /hooks · /paste-image · /memory · /migrate · /goal · /remember · /quit · /help · 以及 skills（/init、/explore …）",
