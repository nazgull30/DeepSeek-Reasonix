...
var English = Messages{
	...
	NoSessionToDelete:         "no saved sessions to delete",
	SessionDeletePickTitle:    "Delete a saved session",
	SessionDeletePickHint:     "↑/↓ move · Enter select · Esc cancel",
	SessionDeletePromptFmt:    "Delete session %s? This cannot be undone.",
	SessionDeletePromptMeta:   "Removes the transcript, branch history, checkpoints, and subagent sessions.",
	SessionDeleteDone:         "session deleted",
	SessionDeleteFailed:       "could not delete session",
	SessionDeleteActive:       "cannot delete the active session — use /clear to discard it",
	StatusSessionDeletePicker: "session delete",
	SlashUnavailable:          "command unavailable in this build",
	SlashUnknown:              "unknown command",
	SlashTodoCleared:          "task list dismissed",
	SlashHelp:                 "commands: /compact · /new · /clear · /resume · /session-delete · /rewind · /tree · /branch · /switch · /todo · /verbose · /model (switch model) · /effort · /theme · /language · /mcp · /skills · /hooks · /paste-image · /memory · /migrate · /goal · /remember · /quit · /help · plus skills (/init, /explore, …)",
	...
	CmdSessionDelete:    "delete a saved session",
