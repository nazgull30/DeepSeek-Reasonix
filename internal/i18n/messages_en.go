...
var English = Messages{
	...
	InputCopied:                  "copied input to clipboard",
	InputCopyEmpty:               "input is empty — nothing to copy",
	...
	CmdExportSessions:          "export all session state for cache analysis",
	...
	SlashExportSessionsDoneFmt: "session snapshot exported to %s",
	SlashExportSessionsEmpty:   "no sessions to export",
	...
	FlowTitle:           "Flow — session",
	FlowTurnsFmt:        "%d turns",
	FlowMainAgent:       "main agent",
	FlowSubagentAll:     "subagents (session)",
