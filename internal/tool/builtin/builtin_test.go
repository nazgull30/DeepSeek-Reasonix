...
func TestBuiltinsRegistered(t *testing.T) {
	want := []string{"bash", "code_index", "edit_file", "glob", "grep", "ls", "move_file", "multi_edit", "read_file", "read_image", "web_fetch", "write_file"}
...
func TestBuiltinReadOnlyClassification(t *testing.T) {
	readOnly := map[string]bool{
		"read_file": true, "read_image": true, "ls": true, "glob": true, "grep": true, "code_index": true, "web_fetch": true,
