...
func (g grepTool) Description() string {
	if g.rg != "" {
		return "Search for a regex in a file or directory. ripgrep-backed, honors .gitignore. Returns path:line:text matches, capped at 200."
	}
	return "Search for a regex in a file or directory (skips hidden/.gitignored files). Returns path:line:text matches, capped at 200."
}
